...
public class PageViewController: UIViewController {
    ...
    public required init(dataSource: PageViewControllerDatasource? = nil,
...
private extension PageViewController {
    ...
    func preloadNext() {
        ...
        while index > 0, var next = node.next {
    ...
    func preloadPrevious() {
        guard var node = _visibleNode else { return }
        var index = workingRangeSize
        while index > 0, var previous = node.previous {
