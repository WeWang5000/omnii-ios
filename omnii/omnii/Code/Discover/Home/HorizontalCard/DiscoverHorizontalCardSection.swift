//
//  DiscoverHorizontalCardSection.swift
//  omnii
//
...
final class DiscoverHorizontalCardSection: ListSectionController {
    
    typealias Cell = DiscoverHorizontalCardCell
    ...
    override func sizeForItem(at index: Int) -> CGSize {
        return CGSize(width: 190.rpx, height: 337.rpx)
    }
