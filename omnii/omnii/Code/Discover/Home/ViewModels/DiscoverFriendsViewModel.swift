//
//  DiscoverFriendsViewModel.swift
//  omnii
//
...
protocol DiscoverFriendsViewModelInputs {
    func request(params: [String : Any]?, more: Bool)
}

protocol DiscoverFriendsViewModelOutputs {
    var dataSource: [DiscoverRecordViewModel] { get }
}

final class DiscoverFriendsViewModel {
    
    var input: DiscoverFriendsViewModelInputs { self }
    var output: DiscoverFriendsViewModelOutputs { self }
...
extension DiscoverFriendsViewModel: DiscoverFriendsViewModelInputs {
    ...
    func request(params: [String : Any]?, more: Bool) {
        ...
        Provider.requestPublisher(.discoverFriends(requestParams))
...
extension DiscoverFriendsViewModel: DiscoverFriendsViewModelOutputs {
